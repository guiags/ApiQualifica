...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::middleware('auth:sanctum')->put('/pessoas/{id}', [PessoaController::class, 'update']);
    Route::middleware('auth:sanctum')->delete('/pessoas/{id}', [PessoaController::class, 'destroy']);
